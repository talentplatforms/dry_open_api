RSpec.describe DryOpenApi::Info do
  ...
  describe '.load' do
    ...
    before do
      allow(DryOpenApi::Contact).to receive(:load).and_return(contact)
      allow(DryOpenApi::License).to receive(:load).and_return(license)
    end
